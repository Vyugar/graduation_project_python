...
К диплому в качестве **практического материала** прилагаются написанные на **Python** с использованием популярных библиотек для разработки игр игры **"Ursina Minecraft"**, **"Pygame Angry Birds"**, **"Panda3d Arena"** и **"Harfang Dogfight"**.
