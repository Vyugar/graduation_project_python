...
2) **"Angry Birds"**  - с использованием библиотек *pygame* (для создания полноценных игр), *pymunk* (для создания 2D-физики на Python), *cffi* (для вызова кода C) и *pycparser* (полного парсера языка C) на **Python**.
